...
import type { FinalCTASection as FinalCTASectionContent } from "@/lib/mockWordpressClient";
...
export function FinalCTASection({ content, locale }: FinalCTASectionProps) {
  return (
    <section className="relative mx-auto w-[96%] max-w-7xl px-6 pb-24 pt-24 sm:px-10">
      <div className="relative overflow-hidden rounded-3xl border border-neutral-900 bg-[#090909] px-10 py-16 sm:px-16">
        ...
        <div className="relative flex flex-col gap-10">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              ...
              className="cta-button relative inline-flex items-center gap-3 overflow-hidden border border-white/70 px-6 py-3 text-sm uppercase tracking-[0.4em] text-neutral-50 hover:text-[#040404]"
            >
